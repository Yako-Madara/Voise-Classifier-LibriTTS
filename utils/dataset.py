...
def load_libritts_item(
    ...
    speaker_id, chapter_id, _, utterance_id = fileid.split("_")
    utterance_id = fileid
    ...
    gender = gender_labels[int(speaker_id)]                
...
class LIBRITTS(Dataset):
    ...
    def __init__(
        ...
        if gender_labels is None or transforms is None:
            raise Exception("gender_labels and transforms required arguments")
